...
use ml_transformers::models::quantized_qwen3::ModelWeights as QuantizedQwen3;
...
impl Model {
    ...
    fn process_generation(&mut self, token_to_process: u32) -> ml::Result<String> {
