//! Whisper-tiny audio-feature stage for MuseTalk, in pure Rust (hanzo-ml / hanzo-nn).
//!
//! Library port of the MuseTalk `utils/audio_processor.py` + HF whisper-tiny ENCODER pipeline.
//! Verified byte-for-byte (cosine 1.0 / PSNR ~100 dB cpu-f32) against PyTorch on the demo clip.
//!
...
use hanzo_nn::{linear, linear_no_bias, Conv1d, Conv1dConfig, LayerNorm, Linear, Module, VarBuilder};
...
impl WhisperEncoder {
    ...
    pub fn load(vb: VarBuilder, cfg: &WhisperConfig) -> Result<Self> {
