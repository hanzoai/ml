...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/hanzo/raw/main/hanzo-examples/examples/flux/assets/flux-robot.jpg" alt="" width=320>
//! </div>
//!
//! ```bash
...
//!    --features cuda \
//!    --example pixtral -- \
//!    --image hanzo-examples/examples/flux/assets/flux-robot.jpg
//! ```
//!
//! ```txt
//! Describe the image.
