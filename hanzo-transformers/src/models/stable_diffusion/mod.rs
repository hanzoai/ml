...
//!
//! <div align=center>
//!   <img src="https://github.com/huggingface/hanzo/raw/main/hanzo-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg" alt="rusty robot holding a hanzo" width=320>
//! </div>
//!
//! _"A rusty robot holding a fire torch in its hand."_ Generated by Stable Diffusion XL using Rust and [hanzo](https://github.com/huggingface/hanzo).
//!
//! ```bash
//! # example running with cuda
//! # see the hanzo-examples/examples/stable-diffusion for all options
