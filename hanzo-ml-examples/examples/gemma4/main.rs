...
use hanzo_transformers::models::gemma4::{
...
fn main() -> Result<()> {
    ...
    let args = Args::parse();
    #[cfg(feature = "cuda")]
    hanzo_ml::quantized::cuda::set_force_dmmv(args.force_dmmv);
    ...
    let filenames = match args.weight_files {
        Some(files) => files
            ...
            .collect::<Vec<_>>(),
        None => {
            match hanzo_ml_examples::hub_load_safetensors(&repo, "model.safetensors.index.json") {
                Ok(files) => files,
