...
use hanzo_transformers::models::qwen2::{Config as ConfigBase, ModelForCausalLM as ModelBase};
use hanzo_transformers::models::qwen2_moe::{Config as ConfigMoe, Model as ModelMoe};
...
impl Model {
    fn forward(&mut self, xs: &Tensor, s: usize) -> hanzo_ml_core::Result<Tensor> {
        match self {
