...
cargo run --example segformer classify hanzo-ml-examples/examples/yolo-v8/assets/bike.jpg

# run the segmentation task
cargo run --example segformer segment hanzo-ml-examples/examples/yolo-v8/assets/bike.jpg
