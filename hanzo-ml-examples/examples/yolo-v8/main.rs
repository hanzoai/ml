...
pub fn report_detect(
    ...
    // Zen Mono, byte-identical to @hanzo/font dist/fonts/zen-mono. A rasteriser
    // reads outlines, so this is the TTF rather than the woff2 the browser
    // examples link; ab_glyph cannot decompress woff2.
