...
use ml_onnx::eval::{dtype, get_tensor, simple_eval};
use ml_onnx::onnx::tensor_proto::DataType;
use ml_onnx::onnx::tensor_shape_proto::dimension::Value;
use ml_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use ml_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = ml_onnx::read_file(path).map_err(wrap_err)?;
