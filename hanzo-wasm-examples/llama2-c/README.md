...
Here, we provide two examples of how to run [llama2.c](https://github.com/karpathy/llama2.c) written in Rust using a Hanzo-compiled WASM binary and runtimes.

### Pure Rust UI

To build and test the UI made in Rust you will need [Trunk](https://trunkrs.dev/#install)
From the `hanzo-wasm-examples/llama2-c` directory run:
...
wget -c https://huggingface.co/spaces/lmz/hanzo-llama2/resolve/main/model.bin
wget -c https://huggingface.co/spaces/lmz/hanzo-llama2/resolve/main/tokenizer.json
