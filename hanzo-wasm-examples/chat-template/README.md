# hanzo-wasm-chat-template

Shared chat template support for hanzo WASM LLM examples.
...
```toml
[dependencies]
hanzo-wasm-chat-template = { path = "../chat-template" }
```

### Rust

```rust
use hanzo_wasm_chat_template::{ChatTemplate, Message, Conversation, ChatTemplateOptions};
