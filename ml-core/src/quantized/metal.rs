...
use ml_metal_kernels::metal::Buffer;
use std::sync::Arc;
...
impl QMetalStorage {
    ...
    fn fwd_mv(
        ...
        for batch_id in 0..m {
            ml_metal_kernels::call_quantized_matmul_mv_t(
                device.device(),
                &encoder,
                device.kernels(),
                self.dtype.into(),
    ...
    pub fn fwd(
        ...
        ml_metal_kernels::call_quantized_matmul_mm_t(
            device.device(),
            &encoder,
            device.kernels(),
            self.dtype.into(),
...
impl From<GgmlDType> for ml_metal_kernels::GgmlDType {
    fn from(value: GgmlDType) -> Self {
        match value {
            GgmlDType::Q4_0 => ml_metal_kernels::GgmlDType::Q4_0,
            GgmlDType::Q4_1 => ml_metal_kernels::GgmlDType::Q4_1,
            GgmlDType::Q5_0 => ml_metal_kernels::GgmlDType::Q5_0,
            GgmlDType::Q5_1 => ml_metal_kernels::GgmlDType::Q5_1,
            GgmlDType::Q8_0 => ml_metal_kernels::GgmlDType::Q8_0,
            GgmlDType::Q8_1 => ml_metal_kernels::GgmlDType::Q8_1,
            GgmlDType::Q2K => ml_metal_kernels::GgmlDType::Q2K,
            GgmlDType::Q3K => ml_metal_kernels::GgmlDType::Q3K,
            GgmlDType::Q4K => ml_metal_kernels::GgmlDType::Q4K,
            GgmlDType::Q5K => ml_metal_kernels::GgmlDType::Q5K,
            GgmlDType::Q6K => ml_metal_kernels::GgmlDType::Q6K,
            GgmlDType::Q8K => ml_metal_kernels::GgmlDType::Q8K,
            GgmlDType::F16 => ml_metal_kernels::GgmlDType::F16,
            GgmlDType::F32 => ml_metal_kernels::GgmlDType::F32,
            GgmlDType::BF16 => ml_metal_kernels::GgmlDType::F16,
        }
    }
}
