...
pub fn call_quantized_get_rows(
    ...
    let name = match dtype {
        ...
        GgmlDType::IQ2_XXS => "kernel_get_rows_iq2_xxs",
        GgmlDType::IQ2_XS => "kernel_get_rows_iq2_xs",
        GgmlDType::IQ2_S => "kernel_get_rows_iq2_s",
        GgmlDType::IQ3_XXS => "kernel_get_rows_iq3_xxs",
        GgmlDType::IQ3_S => "kernel_get_rows_iq3_s",
        GgmlDType::IQ1_S => "kernel_get_rows_iq1_s",
        GgmlDType::IQ1_M => "kernel_get_rows_iq1_m",
        GgmlDType::IQ4_NL => "kernel_get_rows_iq4_nl",
        GgmlDType::IQ4_XS => "kernel_get_rows_iq4_xs",
