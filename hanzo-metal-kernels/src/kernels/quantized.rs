...
// === dbc-ONLY validation patch (not in Windows source) =========================
// Offset-aware variants for the Metal resident-[E,n,k] MoE bank path
// (moe_expert_matmul). Identical to the non-offset fns above except the
// QUANTIZED WEIGHT (src0/rhs) is bound at a byte offset into the bank.
#[allow(clippy::too_many_arguments)]
