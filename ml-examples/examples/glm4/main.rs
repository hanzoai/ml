...
use ml_transformers::models::glm4::{Config as ConfigOld, EosTokenId, Model as ModelOld};
use ml_transformers::models::glm4_new::{Config as ConfigNew, ModelForCausalLM as ModelNew};
