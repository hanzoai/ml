...
use ml_transformers::models::llama::{Cache, Llama, LlamaConfig};
use ml_transformers::models::snac::{Config as SnacConfig, Model as SnacModel};
...
struct Model {
    model: Llama,
    tokenizer: Tokenizer,
    logits_processor: ml_transformers::generation::LogitsProcessor,
    cache: Cache,
    device: Device,
    verbose_prompt: bool,
    snac: SnacModel,
