...
use ml_transformers::models::mistral::{Config, Model as Mistral};
use ml_transformers::models::quantized_mistral::Model as QMistral;

use ml::{DType, Device, Tensor};
use candle_examples::token_output_stream::TokenOutputStream;
use ml_nn::VarBuilder;
use ml_transformers::generation::{LogitsProcessor, Sampling};
...
fn main() -> Result<()> {
    ...
    let args = Args::parse();
    #[cfg(feature = "cuda")]
    ml::quantized::cuda::set_force_dmmv(args.force_dmmv);
