...
use ml_transformers::models::jina_bert::{BertModel, Config, PositionEmbeddingType};

use anyhow::Error as E;
use ml::{DType, Module, Tensor};
...
pub fn normalize_l2(v: &Tensor) -> ml::Result<Tensor> {
