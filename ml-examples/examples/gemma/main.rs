...
use ml_transformers::models::gemma::{Config as Config1, Model as Model1};
use ml_transformers::models::gemma2::{Config as Config2, Model as Model2};
use ml_transformers::models::gemma3::{Config as Config3, Model as Model3};
...
impl Model {
    fn forward(&mut self, input_ids: &Tensor, pos: usize) -> ml::Result<Tensor> {
        match self {
