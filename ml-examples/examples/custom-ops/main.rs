...
use ml::{CpuStorage, CustomOp1, Layout, Result, Shape, Tensor};
...
impl CustomOp1 for LayerNorm {
    ...
    fn cuda_fwd(
        ...
        use ml::cuda_backend::cudarc::driver::{LaunchConfig, PushKernelArg};
        ...
        builder.arg(&dst);
        builder.arg(&slice);
        ml::builder_arg!(builder, self.eps, d1, d2);
        unsafe { builder.launch(cfg) }.w()?;

        let dst = ml::CudaStorage::wrap_cuda_slice(dst, dev);
