...
use ml_transformers::models::quantized_llama as model;
...
fn main() -> anyhow::Result<()> {
    ...
    ml::cuda::set_gemm_reduced_precision_f16(true);
    ml::cuda::set_gemm_reduced_precision_bf16(true);
    ...
    for prompt_index in 0.. {
        ...
        if let Some(rest) = tos.decode_rest().map_err(ml::Error::msg)? {
            print!("{rest}");
        }
        std::io::stdout().flush()?;
