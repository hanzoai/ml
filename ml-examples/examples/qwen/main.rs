...
use ml_transformers::models::qwen2::{Config as ConfigBase, ModelForCausalLM as ModelBase};
use ml_transformers::models::qwen2_moe::{Config as ConfigMoe, Model as ModelMoe};
use ml_transformers::models::qwen3::{Config as Config3, ModelForCausalLM as Model3};
use ml_transformers::models::qwen3_moe::{Config as ConfigMoe3, ModelForCausalLM as ModelMoe3};
...
impl Model {
    fn forward(&mut self, xs: &Tensor, s: usize) -> ml::Result<Tensor> {
        match self {
