...
use ml_nn::{linear, linear_no_bias, VarBuilder};
...
fn flash_attn(_: &Tensor, _: &Tensor, _: &Tensor, _: f32, _: bool) -> Result<Tensor> {
    ml::bail!("flash-attn feature not enabled, compile with '--features flash-attn'")
}
...
pub struct TimestepEmbedder {
    linear1: ml_nn::Linear,
    linear2: ml_nn::Linear,
...
impl ZImageAttention {
    ...
    fn attention_metal(
        ...
        ml_nn::ops::sdpa(q, k, v, sdpa_mask.as_ref(), false, scale as f32, 1.0)
    }
    ...
    fn attention_basic(
        ...
        let attn_probs = ml_nn::ops::softmax_last_dim(&attn_weights)?;
        attn_probs.matmul(v)
    }
...
pub struct ZImageTransformerBlock {
    ...
    ffn_norm1: RmsNorm,
    ffn_norm2: RmsNorm,
    adaln_modulation: Option<ml_nn::Linear>,
}
...
pub struct ZImageTransformer2DModel {
    ...
    cap_embedder_linear: ml_nn::Linear,
    x_embedder: ml_nn::Linear,
