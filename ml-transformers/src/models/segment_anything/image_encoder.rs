use ml::{DType, IndexOp, Result, Tensor};
use ml_nn::{layer_norm, LayerNorm, Module, VarBuilder};
...
impl PatchEmbed {
    fn new(
        ...
        let proj = ml_nn::conv2d(in_chans, embed_dim, k_size, cfg, vb.pp("proj"))?;
...
impl ml::CustomOp3 for Add3 {
    ...
    fn cpu_fwd(
        ...
        let dst = ml::WithDType::to_cpu_storage_owned(dst);
...
impl Block {
    fn new(
        ...
        let mlp = super::MlpBlock::new(dim, dim * 4, ml_nn::Activation::Gelu, vb.pp("mlp"))?;
...
impl ImageEncoderViT {
    ...
    pub fn new(
        ...
        let neck_conv1 = ml_nn::conv2d_no_bias(
            embed_dim,
            out_chans,
            1,
            Default::default(),
        ...
        let neck_conv2 = ml_nn::conv2d_no_bias(out_chans, out_chans, 3, cfg, vb.pp("neck.2"))?;
