...
pub struct MaskDecoder {
    iou_token: ml_nn::Embedding,
    mask_tokens: ml_nn::Embedding,
    iou_prediction_head: MlpMaskDecoder,
    output_upscaling_conv1: ml_nn::ConvTranspose2d,
    output_upscaling_ln: super::LayerNorm2d,
    output_upscaling_conv2: ml_nn::ConvTranspose2d,
...
impl MaskDecoder {
    pub fn new(
        ...
        let iou_token = ml_nn::embedding(1, transformer_dim, vb.pp("iou_token"))?;
        let mask_tokens =
            ml_nn::embedding(num_mask_tokens, transformer_dim, vb.pp("mask_tokens"))?;
        let cfg = ml_nn::ConvTranspose2dConfig {
            stride: 2,
            ..Default::default()
        };
        let output_upscaling_conv1 = ml_nn::conv_transpose2d(
            transformer_dim,
            transformer_dim / 4,
            2,
            cfg,
        ...
        let output_upscaling_conv2 = ml_nn::conv_transpose2d(
            transformer_dim / 4,
            transformer_dim / 8,
            2,
            cfg,
