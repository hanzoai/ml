...
use ml::{ModuleT, Result, Tensor};
use ml_nn::{FuncT, VarBuilder};
...
fn fully_connected(
    ...
    let dropout1 = ml_nn::Dropout::new(0.5);
    let dropout2 = ml_nn::Dropout::new(0.5);
    let dropout3 = ml_nn::Dropout::new(0.5);
    Ok(FuncT::new(move |xs, train| {
        ...
        let lin3 = ml_nn::linear(4096, num_classes, vb.pp("head.fc"))?;
...
fn get_weights_and_biases(
    ...
    Ok(ml_nn::Linear::new(ws, Some(bs)))
}
