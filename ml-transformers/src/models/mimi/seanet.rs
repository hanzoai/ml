...
use ml::{streaming, Module, Result, StreamTensor, StreamingModule, Tensor};
...
pub struct Config {
    ...
    pub activation: ml_nn::Activation,
    ...
    pub final_activation: Option<ml_nn::Activation>,
}
...
impl SeaNetResnetBlock {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            shortcut,
            activation,
            skip_op: streaming::StreamingBinOp::new(streaming::BinOp::Add, ml::D::Minus1),
...
impl SeaNetEncoder {
    pub fn new(cfg: &Config, vb: VarBuilder) -> Result<Self> {
        if cfg.lstm > 0 {
            ml::bail!("seanet lstm is not supported")
        }
...
pub struct SeaNetDecoder {
    ...
    final_conv1d: StreamableConv1d,
    final_activation: Option<ml_nn::Activation>,
    span: tracing::Span,
}
