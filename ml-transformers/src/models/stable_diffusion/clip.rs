...
use ml::{DType, Device, Result, Tensor, D};
use ml_nn as nn;
use ml_nn::Module;
...
impl ClipTextEmbeddings {
    fn new(vs: ml_nn::VarBuilder, c: &Config) -> Result<Self> {
        let token_embedding =
            ml_nn::embedding(c.vocab_size, c.embed_dim, vs.pp("token_embedding"))?;
        let position_embedding = ml_nn::embedding(
...
impl ClipTextTransformer {
    pub fn new(vs: ml_nn::VarBuilder, c: &Config) -> Result<Self> {
