...
pub struct TrOCRConfig {
    ...
    pub activation_function: ml_nn::Activation,
...
impl Default for TrOCRConfig {
    fn default() -> Self {
        Self {
            ...
            activation_function: ml_nn::Activation::Gelu,
...
impl TrOCRForCausalLM {
    pub fn new(decoder_cfg: &TrOCRConfig, vb: VarBuilder) -> Result<Self> {
        ...
        let output_projection = if decoder_cfg.tie_word_embeddings {
            ml_nn::Linear::new(decoder.embed_tokens.embeddings().clone(), None)
        } else {
            ml_nn::linear_no_bias(
                decoder_cfg.d_model,
