...
impl Config {
    fn hidden_act(&self) -> Result<Activation> {
        match (self.hidden_act, self.hidden_activation) {
            ...
            (Some(_), Some(_)) => ml::bail!("both hidden_act and hidden_activation are set"),
            (None, None) => ml::bail!("none of hidden_act and hidden_activation are set"),
        }
    }
}
...
impl Model {
    ...
    pub fn embed_tokens(&self) -> &ml_nn::Embedding {
        &self.embed_tokens
    }
