...
#[cfg(feature = "cuda")]
use hanzo_ml::cuda_backend::kernels::ffi;
#[allow(unused_imports)]
use hanzo_ml::quantized::{self, QTensor};
...
pub fn moe_gemm(
    ...
    >(
        ...
        let data_type = match input.dtype() {
            ...
            DType::BF16 => 1,
            _ => {
                hanzo_ml::bail!("moe_gemm_wmma only accepts f16/bf16 inputs")
            }
        };
    ...
    match input.dtype() {
        ...
        _ => {
            hanzo_ml::bail!("moe_gemm only accepts f16/bf16 inputs")
        }
    }
}
...
pub fn moe_gemm(
    ...
    hanzo_ml::bail!("moe_gemm is only implemented for the cuda backend")
}
...
pub fn moe_gemm_gguf(
    ...
    match input.dtype() {
        ...
        _ => {
            hanzo_ml::bail!("moe_gemm_gguf only accepts f32 inputs")
        }
    }
}
...
pub fn moe_gemm_gguf(
    ...
    hanzo_ml::bail!("moe_gemm_gguf is only implemented for the cuda backend")
}
