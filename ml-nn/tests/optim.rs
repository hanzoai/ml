...
use ml::test_utils::{to_vec0_round, to_vec2_round};

use anyhow::Result;
use ml::{DType, Device, Tensor, Var};
use ml_nn::{AdamW, Linear, Module, Optimizer, ParamsAdamW, SGD};
...
fn adamw_linear_regression_varmap() -> Result<()> {
    ...
    let mut var_map = ml_nn::VarMap::new();
