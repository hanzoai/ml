//! #A simplified example in Rust of training a neural network and then using it based on the Hanzo Framework by Hugging Face.
...
use hanzo::{DType, Result, Tensor, D, Device};
