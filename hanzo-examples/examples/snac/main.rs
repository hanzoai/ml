...
fn main() -> Result<()> {
    ...
    let model = match args.model {
        ...
        None => Api::new()?
            .model("lmz/hanzo-snac".to_string())
        ...
        Action::AudioToCode | Action::AudioToAudio => {
            let pcm = if args.in_file == "-" {
                ...
                if sample_rate != model_sample_rate {
                    ...
                    hanzo_examples::audio::resample(&pcm, sample_rate, model_sample_rate)?
                } else {
                    pcm
                }
            };
    ...
    match args.action {
        ...
        Action::AudioToAudio | Action::CodeToAudio => {
            ...
            let pcm = pcm.i(0)?.i(0)?;
            let pcm = hanzo_examples::audio::normalize_loudness(&pcm, model_sample_rate, true)?;
            ...
            if args.out_file == "-" {
                ...
                hanzo_examples::wav::write_pcm_as_wav(&mut output, &pcm, model_sample_rate)?;
            }
        }
    }
    Ok(())
