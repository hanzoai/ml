...
cargo run --example paddleocr-vl --release -- \
    --image hanzo-examples/examples/paddleocr-vl/test_ocr.png \
    --task ocr
```
...
```bash
cargo run --example paddleocr-vl --release -- \
    --image hanzo-examples/examples/paddleocr-vl/test_table.png \
    --task table
```
...
```bash
cargo run --example paddleocr-vl --release -- \
    --image hanzo-examples/examples/paddleocr-vl/test_formula.png \
    --task formula
```
...
```bash
cargo run --example paddleocr-vl --release -- \
    --image hanzo-examples/examples/paddleocr-vl/test_chart.png \
    --task chart
```
...
cargo run --example paddleocr-vl --release -- \
    --image hanzo-examples/examples/paddleocr-vl/test_ocr.png \
    --image hanzo-examples/examples/paddleocr-vl/test_ocr_page2.png
```
...
cargo run --example paddleocr-vl --release -- \
    --batch hanzo-examples/examples/paddleocr-vl/test_ocr.png hanzo-examples/examples/paddleocr-vl/test_ocr_page2.png

# With shell glob expansion
cargo run --example paddleocr-vl --release -- \
    --batch hanzo-examples/examples/paddleocr-vl/test_ocr*.png
```
...
```bash
cargo run --example paddleocr-vl --release -- \
    --video hanzo-examples/examples/paddleocr-vl/test_video.mp4 \
    --task video \
    --fps 0.6 \
    --max-frames 64 \
    --max-length 2048
