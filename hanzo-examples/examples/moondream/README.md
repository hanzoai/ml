...
Now you can run Moondream from the `hanzo-examples` crate:
```bash
$ cargo run --example moondream --release -- --prompt "Describe the people behind the bikers?" --image "hanzo-examples/examples/yolo-v8/assets/bike.jpg"
