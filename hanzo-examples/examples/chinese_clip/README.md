...
```bash
$ cargo run --example chinese_clip --release -- --images "hanzo-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg","hanzo-examples/examples/yolo-v8/assets/bike.jpg" --cpu --sequences "一场自行车比赛","两只猫的照片","一个机器人拿着蜡烛"
...
```bash 
$ cargo run --features metal --example chinese_clip --release -- --images "hanzo-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg","hanzo-examples/examples/yolo-v8/assets/bike.jpg" --cpu --sequences "一场自行车比赛","两只猫的照片","一个机器人拿着蜡烛"
