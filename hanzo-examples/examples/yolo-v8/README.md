# hanzo-yolo-v8: Object Detection and Pose Estimation
...
You can try this model online on the [Hanzo YOLOv8
Space](https://huggingface.co/spaces/lmz/hanzo-yolo). The model then fully runs
...
### Object Detection
```bash
cargo run --example yolo-v8 --release -- hanzo-examples/examples/yolo-v8/assets/bike.jpg
```
...
cargo run --example yolo-v8 --release -- \
  hanzo-examples/examples/yolo-v8/assets/bike.jpg --task pose
```
