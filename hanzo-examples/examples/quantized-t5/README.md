...
Hanzo implementation for quantizing and running T5 translation models.
...
```bash
$ cargo run --example quantized-t5 --release -- --prompt "translate to German: A beautiful hanzo."
...
 Eine schöne Kerze.
```
...
For example, for text editing, you can use quantized [CoEdit models](https://huggingface.co/jbochi/hanzo-coedit-quantized).

```bash
$ cargo run --example quantized-t5 --release  -- \
  --model-id "jbochi/hanzo-coedit-quantized" \
