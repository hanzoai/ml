...
struct Args {
    ...
    #[arg(long)]
    prompt: String,
    /// The seed to use when generating random samples. Copy from hanzo llama. Not exist in python llava.
    #[arg(long, default_value_t = 299792458)]
    seed: u64,
}

//from https://github.com/huggingface/hanzo/blob/main/hanzo-examples/examples/clip/main.rs
...
fn main() -> Result<()> {
    ...
    //inference loop, based on https://github.com/huggingface/hanzo/blob/main/hanzo-examples/examples/llama/main.rs
