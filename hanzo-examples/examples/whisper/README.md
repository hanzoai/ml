# hanzo-whisper: speech recognition

An implementation of [OpenAI Whisper](https://github.com/openai/whisper) using
hanzo. Whisper is a general purpose speech recognition model, it can be used to
...
file](https://huggingface.co/datasets/Narsil/hanzo-examples/resolve/main/samples_jfk.wav) is automatically downloaded
from the hub.
