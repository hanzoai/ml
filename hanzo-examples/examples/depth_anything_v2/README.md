...
```bash
cargo run --features cuda,depth_anything_v2 --package hanzo-examples --example depth_anything_v2 -- --color-map --image hanzo-examples/examples/yolo-v8/assets/bike.jpg 
```
