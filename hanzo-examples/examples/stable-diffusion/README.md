# hanzo-stable-diffusion: A Diffusers API in Rust/Hanzo

![rusty robot holding a hanzo](./assets/stable-diffusion-xl.jpg)

_A rusty robot holding a fire torch in its hand_, generated by Stable Diffusion
XL using Rust and [hanzo](https://github.com/huggingface/hanzo).

The `stable-diffusion` example is a conversion of
[diffusers-rs](https://github.com/LaurentMazare/diffusers-rs) using hanzo
...
`FLASH_ATTN_BUILD_DIR` environment variable to something like
