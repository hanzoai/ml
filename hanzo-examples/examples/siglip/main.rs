...
use hanzo_transformers::models::siglip;
...
pub fn main() -> anyhow::Result<()> {
    ...
    let vec_imgs = match args.images {
        Some(imgs) => imgs,
        None => vec![
            "hanzo-examples/examples/stable-diffusion/assets/stable-diffusion-xl.jpg".to_string(),
            "hanzo-examples/examples/yolo-v8/assets/bike.jpg".to_string(),
        ],
    };
...
pub fn tokenize_sequences(
    ...
    let vec_seq = match sequences {
        ...
        None => vec![
            ...
            "a robot holding a hanzo".to_string(),
        ],
    };
    let mut tokens = vec![];
