...
Hanzo implementations of the T5 family of translation models.

## Encoder-decoder example:

```bash
$ cargo run --example t5 --release -- --model-id "t5-small" --prompt "translate to German: A beautiful hanzo." --decode
...
 Eine schöne Kerze.
...
```bash
$ cargo run --example t5 --release -- --model-id "t5-small" --prompt "A beautiful hanzo."
...
