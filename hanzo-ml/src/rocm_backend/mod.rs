...
impl RocmQuantType {
    ...
    /// `<T>_FALLBACK` env var forces the scalar path for A/B + as the numeric oracle.
    ...
    fn dp4a_fallback_env(self) -> Option<&'static str> {
        match self {
            Self::Q4K => Some("Q4K_FALLBACK"),
            Self::Q6K => Some("Q6K_FALLBACK"),
            Self::Q2K => Some("Q2K_FALLBACK"),
            Self::Q3K => Some("Q3K_FALLBACK"),
            Self::Q5K => Some("Q5K_FALLBACK"),
            Self::IQ2_XXS => Some("IQ2XXS_FALLBACK"),
            Self::IQ2_XS => Some("IQ2XS_FALLBACK"),
            Self::IQ2_S => Some("IQ2S_FALLBACK"),
            Self::IQ3_XXS => Some("IQ3XXS_FALLBACK"),
            Self::IQ3_S => Some("IQ3S_FALLBACK"),
            Self::IQ1_S => Some("IQ1S_FALLBACK"),
            Self::IQ1_M => Some("IQ1M_FALLBACK"),
            _ => None,
        }
    }
...
impl RocmDevice {
    ...
    pub fn matvec_quant(
        ...
        // any type with its `<T>_FALLBACK` set, falls through to the scalar `qmatvec_core`
...
impl RocmStorage {
    ...
    pub fn flash_attn(
        ...
        if std::env::var("ROCM_FLASH_DEBUG").as_deref() == Ok("1") {
