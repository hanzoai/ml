...
impl VulkanDevice {
    ...
    /// Host-input convenience: uploads `x`, runs [`matvec_q4_0_gpu`], returns the f32 result.
    /// Mirrors [`matvec_q4k`] / `WgpuDevice::matvec_q4_0` so the cross-backend bench calls one name.
    pub fn matvec_q4_0(
        &self,
        wq: &VulkanStorage,
        x: &[f32],
    ...
    /// Host-input convenience: uploads `x`, runs [`matvec_q8_0_gpu`], returns the f32 result.
    /// Mirrors [`matvec_q4k`] / `WgpuDevice::matvec_q8_0` so the cross-backend bench calls one name.
    pub fn matvec_q8_0(
        &self,
        wq: &VulkanStorage,
        x: &[f32],
