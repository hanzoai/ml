...
if __name__ == "__main__":
    ...
    # Enable execution from the hanzo and hanzo-ml-pyo3 directories
    cwd = Path.cwd()
    directory = "py_src/hanzo/"
    if cwd.name != "hanzo-ml-pyo3":
        directory = f"hanzo-ml-pyo3/{directory}"
    ...
    write(hanzo.hanzo, directory, "hanzo", check=args.check)
