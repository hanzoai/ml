...
multimodal model. This example is from [hanzo-ml-llava](https://github.com/chenwanqq/hanzo-ml-llava)
...
2. There are some ops like split, nonzero and where are not supported by hanzo.
