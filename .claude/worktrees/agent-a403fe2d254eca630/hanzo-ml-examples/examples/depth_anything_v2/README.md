...
```bash
cargo run --features cuda,depth_anything_v2 --package hanzo-ml-examples --example depth_anything_v2 -- --color-map --image hanzo-ml-examples/examples/yolo-v8/assets/bike.jpg 
```
