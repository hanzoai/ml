...
A hanzo implementation of inference using a pre-trained [ResNet](https://arxiv.org/abs/1512.03385).
...
```
$ cargo run --example resnet --release -- --image hanzo-ml-examples/examples/yolo-v8/assets/bike.jpg
