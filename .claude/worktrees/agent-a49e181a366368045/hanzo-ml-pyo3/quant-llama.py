# This example shows how the hanzo Python api can be used to replicate llama.cpp.
import sys
from typing import Dict, Tuple, Any
import hanzo
from hanzo.models.llama import QuantizedLlama
from hanzo import utils
...
def main():
    ...
    for token_idx in range(500):
        last_token = tokens[-1]
        lt = hanzo.tensor([last_token]).unsqueeze(0)
        logits = model.forward(lt, len(tokens))
        # Greedy sampling for now
        # pr = hanzo.nn.softmax(logits, -1)
