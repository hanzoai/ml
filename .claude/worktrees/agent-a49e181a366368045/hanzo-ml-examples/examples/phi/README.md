# hanzo-ml-phi: 1.3b and 2.7b LLM with state of the art performance for <10b models.
...
The hanzo implementation provides both the standard version as well as a
quantized variant.
