...
from hanzo.utils import load_safetensors, save_gguf, load_gguf, save_safetensors
...
def test_can_roundtrip_gguf():
    ...
    tensors = {
        "a": hanzo.randn((16, 256)).quantize("q4_0"),
        "b": hanzo.randn((16, 16)).quantize("f32"),
    }
