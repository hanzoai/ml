...
use hanzo_onnx::eval::{dtype, get_tensor, simple_eval};
use hanzo_onnx::onnx::tensor_proto::DataType;
use hanzo_onnx::onnx::tensor_shape_proto::dimension::Value;
use hanzo_onnx::onnx::type_proto::{Tensor as ONNXTensor, Value as ONNXValue};
use hanzo_onnx::onnx::{ModelProto, ValueInfoProto};
...
impl PyONNXModel {
    ...
    fn new(path: String) -> PyResult<Self> {
        let model: ModelProto = hanzo_onnx::read_file(path).map_err(wrap_err)?;
